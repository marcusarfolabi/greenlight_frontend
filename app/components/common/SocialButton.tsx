...
export const SocialButton = ({ provider, isLoading, className, ...props }: SocialButtonProps) => {
    ...
    return (
        <button
            ...
            disabled={isLoading}
            className={clsx(
                "group relative w-full h-12 px-4 rounded-xl transition-all duration-200",
        ...
        >
            {isLoading ? (
                ...
                <div className="flex items-center justify-center w-5 h-5">
                    ...
                    {provider === "apple" && (
                        <svg viewBox="0 0 384 512" className="w-[18px] h-[18px] fill-current">
                    ...
                    {provider === "linkedin" && (
                        <svg viewBox="0 0 448 512" className="w-[18px] h-[18px] fill-[#0077B5]">
